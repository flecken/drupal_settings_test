...
$db_uri = getenv('DRUPAL_DB');
if (!empty($db_uri)) {
	$parsed_db_uri = parse_url($db_uri);
	$databases['default']['default'] = array(
		'driver' => $parsed_db_uri['scheme'],
		'database' => substr($parsed_db_uri['path'], 1),
		'username' => $parsed_db_uri['user'],
		'password' => $parsed_db_uri['pass'],
		'host' => $parsed_db_uri['host'],
		'port' => !empty($parsed_db_uri['port']) ? $parsed_db_uri['port'] : 3306,
		'prefix' => '',
	);
}
...
$conf['site_name'] = 'Second Branch on ECS!';
